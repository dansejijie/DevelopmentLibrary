...
public abstract class PickImageAction extends BaseAction {
    ...
    public void onClick() {
        ...
        RxGalleryFinal.with(getActivity()).image().radio().imageLoader(ImageLoaderType.FRESCO)
                .subscribe(new RxBusResultSubscriber<ImageRadioResultEvent>() {
                    @Override
                    protected void onEvent(ImageRadioResultEvent imageRadioResultEvent) throws Exception {
                        ImageCropBean imageCropBean=imageRadioResultEvent.getResult();
                        onPicked(new File(imageCropBean.getOriginalPath()));
                    }
                }).openGallery();
