...
//                                            (UserInfoProvider.UserInfo) (new LABUserInfo(sessionId, toNickName, toAvator))));
    ...
    private void registerObservers(boolean register) {
        MsgStatusEnum.NIMClient.getService(MsgStatusEnum.NIMClient.class).observeReceiveMessage(this, register);
    }
    ...
    public void receiveReceipt(List<IMMessage> list) {
        messageListPanel.receiveReceipt(list);
    }
    ...
    /***************************
     * 消息接受事件，implement EMMessageListener
     ************************************************/
    ...
    public boolean sendMessage(IMMessage message) {
        ...
        MsgStatusEnum.NIMClient.getService(MsgStatusEnum.NIMClient.class).sendMessage(message, false);
