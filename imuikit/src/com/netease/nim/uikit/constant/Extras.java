...
public interface Extras {
    ...
    String EXTRA_MYNICKNAME="myNickname";
    String EXTRA_MYAVATOR="myAvatar";
    String EXTRA_TOIMID= "toImId";
    String EXTRA_TONICKNAME="toNickname";
    String EXTRA_TOAVATOR="toAvatar";

    String EXTRA_SHARED_PREF="user_info";
    // 参数
    String EXTRA_ACCOUNT = "account";
    String EXTRA_TYPE = "type";
    String EXTRA_ANCHOR = "anchor";
    String EXTRA_FRIEND="friend";
    int EXTRA_MAX_STRANGER_MSG_COUNT=3;//设置最大陌生人发送消息数
