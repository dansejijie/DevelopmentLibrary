...
public class WatchMessagePictureActivity extends Activity {
    ...
    private void queryImageMessages() {
        ...
        MsgStatusEnum.NIMClient.getService(WatchMessagePictureActivity.class).queryMessageListByType(MsgTypeEnum.image, messionId, new RequestCallback<List<EMMessage>>() {
            @Override
