...
import com.lightappbuilder.lab4.labim.delete.RNArgumentsUtils;
...
//            }
    ...
    public void login(final ReadableMap options, final Callback callback) {
        ...
        if (TextUtils.equals(currentUser, userName)&&EMClient.getInstance().isLoggedInBefore()) {
            callback.invoke(null, "success");
        } else if (!TextUtils.isEmpty(currentUser)&&EMClient.getInstance().isLoggedInBefore()) {
