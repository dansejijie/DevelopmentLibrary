...
public class UserProfileManager {
	 ...
	 */
	private List<LABIMHelper.DataSyncListener> syncContactInfosListeners;
...
//		ParseManager.getInstance().onInit(context);
		syncContactInfosListeners = new ArrayList<LABIMHelper.DataSyncListener>();
		sdkInited = true;
		return true;
	}

	public void addSyncContactInfoListener(LABIMHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
	...
	public void removeSyncContactInfoListener(LABIMHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
		if (syncContactInfosListeners.contains(listener)) {
...
//				// return immediately
//				if (!LABIMHelper.getInstance().isLoggedIn()) {
//					return;
//				}
//				if (callback != null) {
...
//		});
	...
	public void notifyContactInfosSyncListener(boolean success) {
		for (LABIMHelper.DataSyncListener listener : syncContactInfosListeners) {
