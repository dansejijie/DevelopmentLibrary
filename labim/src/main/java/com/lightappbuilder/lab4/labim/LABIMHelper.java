...
import com.netease.nim.uikit.extra.delete.IntentUtils;
            ...
            public String getDisplayedText(EMMessage message) {
                ...
                if (user != null) {
                    if (EaseAtMessageHelper.get().isAtMeMsg(message)) {
                        return String.format("提到", user.getNick());
                    }
                    return user.getNick() + ": " + ticker;
                } else {
                    if (EaseAtMessageHelper.get().isAtMeMsg(message)) {
                        return String.format("提到", message.getFrom());
                    }
...
//        appContext.registerReceiver(callReceiver, callFilter);
    ...
    /*class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        @Override
        public void onInvitationAccepted(String s, String s1, String s2) {
            new InviteMessgeDao(appContext).deleteMessage(s);
            ...
            msg.setTime(System.currentTimeMillis());
            msg.setGroupId(s);
            msg.setGroupName(_group == null ? s : _group.getGroupName());
            msg.setReason(s2);
            msg.setGroupInviter(s1);
            Log.d(TAG, s1 + "Accept to join the group：" + _group == null ? s : _group.getGroupName());
        ...
        public void onRequestToJoinReceived(String s, String s1, String s2, String s3) {
            ...
            msg.setGroupName(s1);
            msg.setReason(s3);
            Log.d(TAG, s2 + " Apply to join group：" + s1);
        ...
        public void onRequestToJoinAccepted(String s, String s1, String s2) {
            ...
            msg.addBody(new EMTextMessageBody(s2 + " " + st4));
...
//                }
    ...
    public void saveContact(EaseUser user) {
        contactList.put(user.getAccount(), user);
    ...
    public void updateContactList(List<EaseUser> contactInfoList) {
        for (EaseUser u : contactInfoList) {
            contactList.put(u.getAccount(), u);
        }
