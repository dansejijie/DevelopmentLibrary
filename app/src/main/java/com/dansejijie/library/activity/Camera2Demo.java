...
public class Camera2Demo extends Activity implements TextureView.SurfaceTextureListener {
    ...
    public static void start(Context context){
        Intent intent=new Intent(context,Camera2Demo.class);
    ...
    private SurfaceTexture mSurfaceView;
    CameraDevice mCameraDevice;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.test_camera2demo);
    ...
    private void initView() {
        mPreviewView = (TextureView)findViewById(R.id.test_camera2demo_textureview);
...
//      mPreviewBuilder.set(CaptureRequest.CONTROL_AE_MODE,CaptureRequest.CONTROL_AE_MODE_ON_AUTO_FLASH);
        ...
        mImageReader = ImageReader.newInstance(mPreviewSize.getWidth(), mPreviewSize.getHeight(), ImageFormat.JPEG/*此处还有很多格式，比如我所用到YUV等*/, 2/*最大的图片数，mImageReader里能获取到图片数，但是实际中是2+1张图片，就是多一张*/);
